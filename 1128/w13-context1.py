...
context = Input(shape=(19,))                                        # Movie context (genre)
...
context_layer = Dense(8)(context)
context_layer = Activation('gelu')(context_layer)
...
interaction_layer = Dense(8)(interaction_layer)
...
R = Flatten()(R)
R = Concatenate()([R, context_layer, interaction_layer])    #예측정보, 맥락정보, 예측&맥락의관계 concat

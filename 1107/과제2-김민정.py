...
from tensorflow.keras.layers import Dense, Concatenate, Activation, Dropout, BatchNormalization, GlobalAveragePooling1D
...
# Neural network
R = Dense(128, activation='gelu')(R)
R = Dense(128, activation='LeakyReLU')(R)
R = Dense(64, activation='LeakyReLU')(R)
R = Dense(64, activation='LeakyReLU')(R)
R = Dense(32, activation='LeakyReLU')(R)
R = Dense(32, activation='LeakyReLU')(R)
R = Dense(16, activation='linear')(R)
R = Dense(1)(R)
...
model.compile(
  loss=RMSE,
  optimizer=Adamax(learning_rate=0.0002),
  metrics=[RMSE],
)
#model.summary()

...
from tensorflow.keras.layers import Input, Dense, Masking, Activation, Flatten, Dropout
from tensorflow.keras.optimizers import Adamax, SGD
from tensorflow.keras import regularizers


# Variable 초기화 
H1 = 2048                           # Hidden node 수 1
...
masked = Masking(mask_value=0.)(input1) #결측치 마스킹
layer1 = Dense(H1)(masked)
layer1 = Activation('gelu')(layer1)

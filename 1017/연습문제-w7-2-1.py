...
ratings = pd.read_csv('C:/RecoSys/Data/reviews.csv', encoding='latin-1')
...
K = 250
fm1 = FM(num_x, K, data, y, alpha=0.0005, beta=0.001, train_ratio=0.75, iterations=900, tolerance=0.0005, l2_reg=True, verbose=True)
result = fm1.test()

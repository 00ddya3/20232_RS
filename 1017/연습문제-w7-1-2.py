...
users['sex'] = users['sex'].apply(str.upper)
users = users[users['sex'] != ' ']
...
# Genre encoding
genre_dict = {}
genre = ['Action', 'Animation', 'Art_Foreign', 
         'Classic', 'Comedy', 'Drama', 'Family', 'Horror', 'Romance', 'Thriller']
for i in genre:
...
K = 200
fm1 = FM(num_x, K, data, y, alpha=0.0005, beta=0.001, train_ratio=0.75, iterations=600, tolerance=0.001, l2_reg=True, verbose=True)
result = fm1.test()

...
credits = pd.read_csv('C:/RecoSys/Data/credits.csv', encoding='latin-1', low_memory=False) #감독, 배우, ...
keywords = pd.read_csv('C:/RecoSys/Data/keywords.csv', encoding='latin-1', low_memory=False) # 영화 키워드
...
# tfidf는 한 문서 안에 단어가 여러번 등장하는 경우에 적용해야 함

...
mf = NEW_MF(R_temp, K=220, alpha=0.005, beta=0.075, iterations=1100, tolerance=0.005, verbose=True)
test_set = mf.set_test(ratings_test)
result = mf.test()
print(mf.get_one_prediction('A2NO1TXXS9T0EE','B000G6RYNE'),R_temp.loc['A2NO1TXXS9T0EE']['B000G6RYNE'])
print(mf.get_one_prediction('A1IRN1M05TPOVT','B000G6RYNE'),R_temp.loc['A1IRN1M05TPOVT']['B000G6RYNE'])
